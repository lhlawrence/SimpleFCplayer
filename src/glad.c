/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.36 on Wed Dec 20 08:46:59 2023.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=1.3, gles2=3.1
    Profile: core
    Extensions:
    ...
    Commandline:
        --profile="core" --api="gl=1.3,gles2=3.1" --generator="c" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=core&language=c&specification=gl&loader=on&api=gl%3D1.3&api=gles2%3D3.1
*/
...
/* PR #18 */
	...
	if (GLVersion.major > 1 || (GLVersion.major >= 1 && GLVersion.minor >= 3)) {
		max_loaded_major = 1;
		max_loaded_minor = 3;
	}
}
